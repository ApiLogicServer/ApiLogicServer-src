...
changelog:
  ...
  - 2.8 (Nov 16, 2025) - AI Rules support
---
...
- ✅ **Implementation patterns** → `ai_rules_guide.md`
- ✅ **Code templates** → `ai_rules_template.py`
...
**2. Engine Initialization (Dependency analysis)**
