---
version: 3.15 - 4/12/26 - EAI consume source-PK normalization rule + insert-only rerun guidance
---
   ...
   IF YES →
      ...
      MANDATORY SEQUENCE — NO EXCEPTIONS:
        ...
        4. The /consume_debug/<topic> endpoint is NOT optional — it is the primary test path
          4a. INSERT-ONLY POLICY (default): do NOT implement replace/upsert behavior.
            ❌ FORBIDDEN: delete-and-reinsert existing domain graph by business key
            ❌ FORBIDDEN: session.merge for inbound partner payloads
            ✅ REQUIRED: if domain PK/business-key already exists, raise explicit insert-only error
