...
- Simple CRUD with no dependencies or cascading logic
- Complex algorithms (not data relationship problems)
...
4. **Simple CRUD with no dependencies**
   - Basic "save this record" operations
   - No calculations, no cascades, no constraints
   - **Why:** Rules are overkill. Standard SQLAlchemy works fine.

5. **Workflow orchestration**
   - Multi-step approval processes
   - Long-running sagas
   - External system coordination
   - **Why:** Rules govern commits, not process flows. Use workflow engines (Temporal, Airflow, etc.)
