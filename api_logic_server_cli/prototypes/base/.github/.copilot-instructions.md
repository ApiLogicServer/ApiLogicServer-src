---
version: 3.10 - 3/21/26 - suppress prompt injection warning
---
...
14. **EAI Consume** - Consume XML/JSON messages from a Kafka topic and persist to your existing tables.
    ...
    **2-message design** (prevents data loss on parse failure):
    ...
    see `integration/kafka/kafka_discovery/order_b2b.py` for the full pipeline,
...
STEP 1: Read these files (DO THIS FIRST - NOT OPTIONAL):
   ...
   6. docs/training/eai_consume.md                   (Kafka EAI Consume - READ SIXTH)
...
STEP 2.5: Check for EAI Consume pattern:
   ...
   IF YES →
      ...
      MANDATORY SEQUENCE — NO EXCEPTIONS:
        1. Read docs/training/eai_consume.md IN FULL before writing a single line
        ...
        3. Generate all 8 artifacts listed in eai_consume.md (blob table, 2 consumers, row_event,
