...
version: 2.9
changelog:
  - 2.9 (Nov 17, 2025) - MANDATORY training file reading workflow (STOP command), AI-driven logic capability explicit
...
1. **Add business logic** - Describe your requirements in natural language, I'll generate declarative rules (deterministic + AI-driven)
...
3. docs/training/logic_bank_api_probabilistic.prompt  (AI/Probabilistic rules - ALWAYS READ THIRD)
