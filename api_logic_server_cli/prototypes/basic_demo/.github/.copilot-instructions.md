...
---
title: GitHub Copilot Instructions for basic_demo
Description: Message in a bottle for AI assistants - project-specific instructions
Source: org_git/ApiLogicServer-src/api_logic_server_cli/prototypes/basic_demo/.github/.copilot-instructions.md
Propagation: BLT copies to Manager samples/basic_demo_sample/.github/.copilot-instructions.md
Bootstrap: User says "Please find and read .github/.copilot-instructions.md"
Guided Tour: User says "Guide me through basic_demo" → AI reads tutor.md
...
**When user says:** "guide me through basic_demo", "take the guided tour", "show me around", or "walk me through this":

1. **Read `tutor.md`** - Complete instructions for conducting the guided tour
2. **Follow the methodology** - Provoke questions, reveal patterns, build recognition
3. **Use the tour flow** - 20 min walkthrough + 10-25 min Q&A
4. **Key principle:** Make them DISCOVER insights, don't just explain

This is a hands-on exploration, not a lecture. You're the experienced guide showing them around the neighborhood.
