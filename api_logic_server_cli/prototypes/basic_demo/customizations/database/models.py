...
class Customer(Base):  # type: ignore
    ...
    SysMcpList : Mapped[List["SysMcp"]] = relationship(back_populates="customer")
...
class SysMcp(Base):  # type: ignore
    ...
    # parent relationships (access parent)
    customer : Mapped["Customer"] = relationship(back_populates=("SysMcpList"))
