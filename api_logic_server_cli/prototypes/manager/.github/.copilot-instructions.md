...
**When you see ANY of these phrases, IMMEDIATELY:**

1. **Check if `basic_demo/` folder exists** in workspace root (use list_dir or file_search)
2. **Present the appropriate welcome below** - start directly with "Welcome!"

**CRITICAL - Your response must START with "Welcome!" - NO preamble:**
