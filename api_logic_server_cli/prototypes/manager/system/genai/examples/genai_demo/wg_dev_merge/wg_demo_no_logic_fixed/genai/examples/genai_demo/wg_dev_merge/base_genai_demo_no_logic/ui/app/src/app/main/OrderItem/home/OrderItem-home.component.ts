...
@Component({
  selector: 'OrderItem-home',
  templateUrl: './OrderItem-home.component.html',
  styleUrls: ['./OrderItem-home.component.scss']
})
export class OrderItemHomeComponent implements AfterViewInit {
