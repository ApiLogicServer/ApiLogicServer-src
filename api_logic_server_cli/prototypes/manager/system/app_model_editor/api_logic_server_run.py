...
app_logger.info(f'Created July 14, 2024 09:44:34 at {str(current_path)}\n')
...
if __name__ == "__main__":
    msg = f'API Logic Project loaded (not WSGI), version 10.04.91\n'
    ...
    msg = f'API Logic Project Loaded (WSGI), version 10.04.91\n'
    msg += f'.. startup message: {start_up_message}\n'
