...
###############################################################################
#
#    This file initializes and starts the API Logic Server (v 10.03.84, April 26, 2024 11:18:59):
...
app_logger.info(f'Created April 26, 2024 11:18:59 at {str(current_path)}\n')
...
if __name__ == "__main__":
    msg = f'API Logic Project loaded (not WSGI), version 10.03.84\n'
    ...
    msg = f'API Logic Project Loaded (WSGI), version 10.03.84\n'
    msg += f'.. startup message: {start_up_message}\n'
