...
resourcename="basicdemo"  # lower case, only
...
az group create --name basicdemo_rg --location "westus"
az appservice plan create --name myAppServicePlan --resource-group basicdemo_rg --sku S1 --is-linux
az container create --resource-group basicdemo_rg --name basicdemo --image apilogicserver/basicdemo:latest --dns-name-label basicdemo --ports 5656 --environment-variables 'VERBOSE'='True'  'APILOGICPROJECT_CLIENT_URI'='//basicdemo.westus.azurecontainer.io:5656'
