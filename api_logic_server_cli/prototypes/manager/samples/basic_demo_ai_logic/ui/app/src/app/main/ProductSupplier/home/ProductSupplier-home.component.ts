...
@Component({
  selector: 'ProductSupplier-home',
  templateUrl: './ProductSupplier-home.component.html',
  styleUrls: ['./ProductSupplier-home.component.scss']
})
export class ProductSupplierHomeComponent implements AfterViewInit {
