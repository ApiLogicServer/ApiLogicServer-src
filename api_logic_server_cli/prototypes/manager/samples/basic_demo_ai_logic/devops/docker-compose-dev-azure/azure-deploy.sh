...
resourcename="basicdemoagentic"  # lower case, only
resourcegroup="basicdemoagentic_rg"
...
# git clone https://github.com/apilogicserver/basicdemoagentic.git
# cd basicdemoagentic
...
az group create --name basicdemoagentic_rg --location "westus"
az appservice plan create --name myAppServicePlan --resource-group basicdemoagentic_rg --sku S1 --is-linux
az container create --resource-group basicdemoagentic_rg --name basicdemoagentic --image apilogicserver/basicdemoagentic:latest --dns-name-label basicdemoagentic --ports 5656 --environment-variables 'VERBOSE'='True'  'APILOGICPROJECT_CLIENT_URI'='//basicdemoagentic.westus.azurecontainer.io:5656'
