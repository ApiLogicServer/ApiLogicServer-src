...
resourcename="demoeai"  # lower case, only
resourcegroup="demoeai_rg"
...
# git clone https://github.com/apilogicserver/demoeai.git
# cd demoeai
...
az group create --name demoeai_rg --location "westus"
az appservice plan create --name myAppServicePlan --resource-group demoeai_rg --sku S1 --is-linux
az container create --resource-group demoeai_rg --name demoeai --image apilogicserver/demoeai:latest --dns-name-label demoeai --ports 5656 --environment-variables 'VERBOSE'='True'  'APILOGICPROJECT_CLIENT_URI'='//demoeai.westus.azurecontainer.io:5656'
