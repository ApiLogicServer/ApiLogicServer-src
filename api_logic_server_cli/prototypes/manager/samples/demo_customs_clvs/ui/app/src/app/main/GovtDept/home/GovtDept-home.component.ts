...
@Component({
  selector: 'GovtDept-home',
  templateUrl: './GovtDept-home.component.html',
  styleUrls: ['./GovtDept-home.component.scss']
})
export class GovtDeptHomeComponent implements AfterViewInit {
