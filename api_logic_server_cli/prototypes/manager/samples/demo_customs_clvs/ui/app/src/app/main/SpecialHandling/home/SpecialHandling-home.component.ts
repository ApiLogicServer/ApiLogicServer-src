...
@Component({
  selector: 'SpecialHandling-home',
  templateUrl: './SpecialHandling-home.component.html',
  styleUrls: ['./SpecialHandling-home.component.scss']
})
export class SpecialHandlingHomeComponent implements AfterViewInit {
