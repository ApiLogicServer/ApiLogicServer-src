...
@Component({
  selector: 'CustomsOffice-home',
  templateUrl: './CustomsOffice-home.component.html',
  styleUrls: ['./CustomsOffice-home.component.scss']
})
export class CustomsOfficeHomeComponent implements AfterViewInit {
