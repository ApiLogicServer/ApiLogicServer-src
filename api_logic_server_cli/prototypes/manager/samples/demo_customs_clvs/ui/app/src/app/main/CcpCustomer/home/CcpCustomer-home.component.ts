...
@Component({
  selector: 'CcpCustomer-home',
  templateUrl: './CcpCustomer-home.component.html',
  styleUrls: ['./CcpCustomer-home.component.scss']
})
export class CcpCustomerHomeComponent implements AfterViewInit {
