...
@Component({
  selector: 'CustomsRegion-home',
  templateUrl: './CustomsRegion-home.component.html',
  styleUrls: ['./CustomsRegion-home.component.scss']
})
export class CustomsRegionHomeComponent implements AfterViewInit {
