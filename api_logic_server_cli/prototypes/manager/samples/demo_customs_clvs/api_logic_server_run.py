...
api_logic_server__version = '17.00.22'
api_logic_server_created__on = 'May 22, 2026 18:00:23'
...
if __name__ == "__main__":
    msg = f'API Logic Project loaded (not WSGI), version: 17.00.22\n'
    ...
    msg = f'API Logic Project Loaded (WSGI), version 17.00.22\n'
    msg += f'.. startup message: {start_up_message}\n'
