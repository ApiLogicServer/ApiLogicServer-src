...
api_logic_server__version = '17.03.10'
api_logic_server_created__on = 'August 11, 2026 18:01:21'
...
if __name__ == "__main__":
    msg = f'API Logic Project loaded (not WSGI), version: 17.03.10\n'
    ...
    msg = f'API Logic Project Loaded (WSGI), version 17.03.10\n'
    msg += f'.. startup message: {start_up_message}\n'
