...
resourcename="basicdemogenailogic"  # lower case, only
resourcegroup="basicdemogenailogic_rg"
...
# git clone https://github.com/apilogicserver/basicdemogenailogic.git
# cd basicdemogenailogic
...
az group create --name basicdemogenailogic_rg --location "westus"
az appservice plan create --name myAppServicePlan --resource-group basicdemogenailogic_rg --sku S1 --is-linux
az container create --resource-group basicdemogenailogic_rg --name basicdemogenailogic --image apilogicserver/basicdemogenailogic:latest --dns-name-label basicdemogenailogic --ports 5656 --environment-variables 'VERBOSE'='True'  'APILOGICPROJECT_CLIENT_URI'='//basicdemogenailogic.westus.azurecontainer.io:5656'
