...
api_logic_server__version = '17.04.01'
api_logic_server_created__on = 'September 21, 2026 17:36:53'
...
if __name__ == "__main__":
    msg = f'API Logic Project loaded (not WSGI), version: 17.04.01\n'
    ...
    msg = f'API Logic Project Loaded (WSGI), version 17.04.01\n'
    msg += f'.. startup message: {start_up_message}\n'
