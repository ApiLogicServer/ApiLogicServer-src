...
api_logic_server__version = '16.02.05'
api_logic_server_created__on = 'March 07, 2026 16:52:10'
...
if __name__ == "__main__":
    msg = f'API Logic Project loaded (not WSGI), version: 16.02.05\n'
    ...
    msg = f'API Logic Project Loaded (WSGI), version 16.02.05\n'
    msg += f'.. startup message: {start_up_message}\n'
