...
api_logic_server__version = '17.00.33'
api_logic_server_created__on = 'June 10, 2026 14:49:58'
...
if __name__ == "__main__":
    msg = f'API Logic Project loaded (not WSGI), version: 17.00.33\n'
    ...
    msg = f'API Logic Project Loaded (WSGI), version 17.00.33\n'
    msg += f'.. startup message: {start_up_message}\n'
