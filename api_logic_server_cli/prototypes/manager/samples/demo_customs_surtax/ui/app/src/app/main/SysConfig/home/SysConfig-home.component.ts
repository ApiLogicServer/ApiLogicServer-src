...
@Component({
  selector: 'SysConfig-home',
  templateUrl: './SysConfig-home.component.html',
  styleUrls: ['./SysConfig-home.component.scss']
})
export class SysConfigHomeComponent implements AfterViewInit {
