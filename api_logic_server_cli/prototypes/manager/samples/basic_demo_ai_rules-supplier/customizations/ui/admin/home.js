const sla_doc =
    ...
    '<h2>Welcome to GenAI-Logic</h2>' +
    '</div><br>' +
    '<h3><a class="custom" style="color: #3f51b5;"  rel="nofollow" href="https://apilogicserver.github.io/Docs/" target="_blank">GenAI-Logic</a> ' +
    'creates customizable, rule-governed systems — instantly, from a prompt or your ' +
    'database:' +
    '</h3>' +
    ...
    '   <li>Custom UI: point your Vibe tool to the logic-enabled API, or use ' +
    '        <a class="custom" style="color: #3f51b5" rel="nofollow" href="https://apilogicserver.github.io/Docs/Admin-Vibe/" target="_blank">React-Vibe</a> for a quick start</li>' +
    '</ul>' +
    ...
    '   <li>MCP-enabled: AI agents discover the schema at ' +
    '        <a class="custom" style="color: #3f51b5" rel="nofollow" href="/.well-known/mcp.json" target="_blank">/.well-known/mcp.json</a></li>' +
