...
@Component({
  selector: 'ShipmentCommodity-home',
  templateUrl: './ShipmentCommodity-home.component.html',
  styleUrls: ['./ShipmentCommodity-home.component.scss']
})
export class ShipmentCommodityHomeComponent implements AfterViewInit {
