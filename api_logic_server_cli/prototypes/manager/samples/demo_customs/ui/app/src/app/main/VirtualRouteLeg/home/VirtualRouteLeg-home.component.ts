...
@Component({
  selector: 'VirtualRouteLeg-home',
  templateUrl: './VirtualRouteLeg-home.component.html',
  styleUrls: ['./VirtualRouteLeg-home.component.scss']
})
export class VirtualRouteLegHomeComponent implements AfterViewInit {
