...
resourcename="demoemptypes"  # lower case, only
resourcegroup="demoemptypes_rg"
...
# git clone https://github.com/apilogicserver/demoemptypes.git
# cd demoemptypes
...
az group create --name demoemptypes_rg --location "westus"
az appservice plan create --name myAppServicePlan --resource-group demoemptypes_rg --sku S1 --is-linux
az container create --resource-group demoemptypes_rg --name demoemptypes --image apilogicserver/demoemptypes:latest --dns-name-label demoemptypes --ports 5656 --environment-variables 'VERBOSE'='True'  'APILOGICPROJECT_CLIENT_URI'='//demoemptypes.westus.azurecontainer.io:5656'
