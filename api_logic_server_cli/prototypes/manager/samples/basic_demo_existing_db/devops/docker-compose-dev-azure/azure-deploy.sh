...
resourcename="basicdemoexistingdb"  # lower case, only
resourcegroup="basicdemoexistingdb_rg"
...
# git clone https://github.com/apilogicserver/basicdemoexistingdb.git
# cd basicdemoexistingdb
...
az group create --name basicdemoexistingdb_rg --location "westus"
az appservice plan create --name myAppServicePlan --resource-group basicdemoexistingdb_rg --sku S1 --is-linux
az container create --resource-group basicdemoexistingdb_rg --name basicdemoexistingdb --image apilogicserver/basicdemoexistingdb:latest --dns-name-label basicdemoexistingdb --ports 5656 --environment-variables 'VERBOSE'='True'  'APILOGICPROJECT_CLIENT_URI'='//basicdemoexistingdb.westus.azurecontainer.io:5656'
