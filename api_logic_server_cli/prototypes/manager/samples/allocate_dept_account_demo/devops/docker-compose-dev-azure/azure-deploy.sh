...
resourcename="allodeptgl2"  # lower case, only
resourcegroup="allodeptgl2_rg"
...
# git clone https://github.com/apilogicserver/allodeptgl2.git
# cd allodeptgl2
...
az group create --name allodeptgl2_rg --location "westus"
az appservice plan create --name myAppServicePlan --resource-group allodeptgl2_rg --sku S1 --is-linux
az container create --resource-group allodeptgl2_rg --name allodeptgl2 --image apilogicserver/allodeptgl2:latest --dns-name-label allodeptgl2 --ports 5656 --environment-variables 'VERBOSE'='True'  'APILOGICPROJECT_CLIENT_URI'='//allodeptgl2.westus.azurecontainer.io:5656'
