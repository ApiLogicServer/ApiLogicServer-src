...
api_logic_server__version = '16.03.00'
api_logic_server_created__on = 'March 12, 2026 19:47:33'
...
if __name__ == "__main__":
    msg = f'API Logic Project loaded (not WSGI), version: 16.03.00\n'
    ...
    msg = f'API Logic Project Loaded (WSGI), version 16.03.00\n'
    msg += f'.. startup message: {start_up_message}\n'
