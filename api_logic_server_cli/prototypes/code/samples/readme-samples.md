...
* [sample](https://apilogicserver.github.io/Docs/Sample-Database/) - the completed tutorial.  It's the same database, but with logic/Python ***customizations added***.  It's a great resource for exploring.  
