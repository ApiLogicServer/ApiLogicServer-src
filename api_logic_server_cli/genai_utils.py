...
class GenAIUtils:
    ...
    def submit_project(self):
        ...
        self.messages = self.get_prompt_messages()
        try:
    ...
    def get_prompt_messages(self) -> List[Dict[str, str]]:
        ...
        assert Path(self.project.genai_using).is_dir(), f"Missing directory: {self.project.genai_using}"
