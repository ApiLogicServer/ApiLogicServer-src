...
__version__ = "15.00.31"  # last public release: 15.00.25 (15.00.12)
recent_changes = \
    f'\n\nRecent Changes:\n' +\
    "\t06/29/2024 - 15.00.31: Tech Preview: als genai-app w/ sra provider+model+grid_cascadeAdd, imports+, bug [96] \n"\
