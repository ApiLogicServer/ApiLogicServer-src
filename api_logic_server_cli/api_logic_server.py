...
__version__ = "15.00.07"  # last public release: 15.00.00 (14.05.04)
recent_changes = \
    f'\n\nRecent Changes:\n' +\
    "\t06/07/2024 - 15.00.06: Optional shortening of stacktrace lines, fan-out[] w/log, s/a or POST, genai cli no rules fix \n"\
