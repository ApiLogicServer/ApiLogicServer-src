...
__version__ = "14.05.17"  # last public release: 14.05.00
recent_changes = \
    f'\n\nRecent Changes:\n' +\
    "\t05/28/2024 - 14.05.17: tour - re-factored default mcp req with generic Post, email stub, use basic_demo custs for genai_demo \n"\
