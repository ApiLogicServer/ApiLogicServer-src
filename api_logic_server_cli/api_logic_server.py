...
__version__ = "15.00.51"  # last public release: 15.00.41 (15.00.12)
recent_changes = \
    f'\n\nRecent Changes:\n' +\
    "\t07/18/2024 - 15.00.51: Python 3.13 compatibility fixes - psycopg2→psycopg3, SQLAlchemy 2.0+, pkg_resources→importlib.metadata \n"\
