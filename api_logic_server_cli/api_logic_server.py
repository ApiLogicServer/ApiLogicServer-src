...
__version__ = "15.00.39"  # last public release: 15.00.36 (15.00.12)
recent_changes = \
    f'\n\nRecent Changes:\n' +\
    "\t07/07/2024 - 15.00.39: copilot vibe, fix mgr symlink creation, nw cards, mgr readme diagnostics, mcp printer, bug[98] \n"\
