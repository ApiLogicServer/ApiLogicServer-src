...
__version__ = "17.00.33"  # last public release: 17.00.32
recent_changes = \
    f'\n\nRecent Changes:\n' +\
    "\t06/03/2026 - 17.00.33  logic report / flow diagram, cvls with hazmat, basic_demo_logic_gov, sec & raw logic fixes \n"\
...
def create_project_and_overlay_prototypes(project: 'ProjectRun', msg: str) -> str:
    """
    Delegates to clone_and_overlay_prototypes/project_overlay.py — extracted for maintainability.
    See that file for full implementation details.
    """
    from clone_and_overlay_prototypes.project_overlay import create_project_and_overlay_prototypes as _impl
    return _impl(project, msg)
