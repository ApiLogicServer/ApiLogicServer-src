...
__version__ = "15.00.16"  # last public release: 15.00.12 (15.00.10)
recent_changes = \
    f'\n\nRecent Changes:\n' +\
    "\t06/16/2024 - 15.00.16: running genai-app, MCP Security, win fixes for readme, graphics quotes, Keycloak provider fix \n"\
