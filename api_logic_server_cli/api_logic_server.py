...
__version__ = "17.00.34"  # last public release: 17.00.33
recent_changes = \
    f'\n\nRecent Changes:\n' +\
    "\t06/10/2026 - 17.00.34  logic report / flow diagram, cvls with hazmat, basic_demo_logic_gov, sec & raw logic fixes \n"\
