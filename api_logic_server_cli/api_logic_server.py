...
__version__ = "14.00.31"
recent_changes = \
    f'\n\nRecent Changes:\n' +\
    "\t12/21/2024 - 14.00.31: successful import of export, fix genai_svcs.model2code, fix safrs_basex removal, with option for just opt_lock for clean models \n"\
