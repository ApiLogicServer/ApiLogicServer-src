...
__version__ = "14.00.06"
recent_changes = \
    f'\n\nRecent Changes:\n' +\
    "\t11/30/2024 - 14.00.06: genai: use_case, openai 1.55.3, no initial logic, use_case, learned logic suggestions, logic suggestion fixes 1, bug fixes \n"\
