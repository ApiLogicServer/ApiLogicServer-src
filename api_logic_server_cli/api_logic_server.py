...
__version__ = "14.00.27"
recent_changes = \
    f'\n\nRecent Changes:\n' +\
    "\t12/20/2024 - 14.00.27: model driven api (fails multi-db), import(ish), missing active_rules, logicbank 1.20.12 - fail-save rules, BLT files for N8N \n"\
