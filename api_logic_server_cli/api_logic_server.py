...
__version__ = "16.04.17"  # last public release: 16.04.15
recent_changes = \
    f'\n\nRecent Changes:\n' +\
    "\t04/16/2026 - 16.04.17  EAI/Kafka CE pub/sub automation, demo_eai, xr, session.merge bug, mgr readme, ins only, demo-eai  \n"\
