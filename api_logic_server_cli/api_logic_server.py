...
__version__ = "15.00.15"  # last public release: 15.00.12 (15.00.10)
recent_changes = \
    f'\n\nRecent Changes:\n' +\
    "\t06/15/2024 - 15.00.15: genai-app, MCP Security, win fixes for readme, graphics quotes, Keycloak provider fix \n"\
