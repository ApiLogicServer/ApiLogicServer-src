...
__version__ = "16.04.09"  # last public release: 16.03.07
recent_changes = \
    f'\n\nRecent Changes:\n' +\
    "\t04/12/2026 - 16.04.09  EAI/Kafka CE pub/sub automation, demo_eai, xr, session.merge bug, mgr readme, ins only  \n"\
