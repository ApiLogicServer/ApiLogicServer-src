...
__version__ = "15.00.59"  # last public release: 15.00.52 (15.00.12)
recent_changes = \
    f'\n\nRecent Changes:\n' +\
    "\t07/25/2024 - 15.00.59: system vibe support -- initial testing, build fix, confluent-kafka==2.6.0 for 3.13 \n"\
