...
__version__ = "17.00.32"  # last public release: 17.00.21
recent_changes = \
    f'\n\nRecent Changes:\n' +\
    "\t06/03/2026 - 17.00.32  logic report / flow diagram, cvls with hazmat, basic_demo_logic_gov, sec & raw logic fixes \n"\
