...
def allo_dept_gl_setup(project: Project, api_logic_server_dir_str: str):
    ...
    if project.project_name_last_node.startswith("allo_dept_gl"): 
        ...
        create_utils.copy_md(project = project, from_doc_file = "Sample_Allo_Dept_GL_readme.md", to_project_file = "readme.md")
