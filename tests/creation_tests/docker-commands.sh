...
echo "cd ~/dev/ApiLogicServer/ApiLogicServer-dev/build_and_test/weg-genai/dockers/; docker run -it --name api_logic_server_local --rm --net dev-network -p 5656:5656 -p 5002:5002 -v ${PWD}:/ApiLogicServer apilogicserver/api_logic_server_local"
