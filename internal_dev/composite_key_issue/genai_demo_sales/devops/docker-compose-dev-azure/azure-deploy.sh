...
resourcename="genaidemosales"  # lower case, only
resourcegroup="genaidemosales_rg"
...
# git clone https://github.com/apilogicserver/genaidemosales.git
# cd genaidemosales
...
az group create --name genaidemosales_rg --location "westus"
az appservice plan create --name myAppServicePlan --resource-group genaidemosales_rg --sku S1 --is-linux
az container create --resource-group genaidemosales_rg --name genaidemosales --image apilogicserver/genaidemosales:latest --dns-name-label genaidemosales --ports 5656 --environment-variables 'VERBOSE'='True'  'APILOGICPROJECT_CLIENT_URI'='//genaidemosales.westus.azurecontainer.io:5656'
