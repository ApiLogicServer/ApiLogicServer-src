...
api_logic_server__version = '17.03.27'
api_logic_server_created__on = 'September 09, 2026 11:09:55'
...
if __name__ == "__main__":
    msg = f'API Logic Project loaded (not WSGI), version: 17.03.27\n'
    ...
    msg = f'API Logic Project Loaded (WSGI), version 17.03.27\n'
    msg += f'.. startup message: {start_up_message}\n'
