# docker buildx build --push -f docker/api_logic_server_all.Dockerfile --tag apilogicserver/api_logic_server_all -o type=image --platform=linux/arm64,linux/amd64 .
# docker tag apilogicserver/api_logic_server_all apilogicserver/api_logic_server_all:9.01.12
# docker buildx build --push --tag apilogicserver/api_logic_server_all:9.01.12 --platform=linux/arm64,linux/amd64 .
