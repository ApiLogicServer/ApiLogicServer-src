...
# docker buildx build --push -f docker/api_logic_server_all_x.Dockerfile --tag apilogicserver/api_logic_server_all_x:9.01.17 -o type=image --platform=linux/arm64,linux/amd64 .
