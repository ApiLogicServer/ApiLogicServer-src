# GA release
# docker buildx build --push -f docker/api_logic_server.Dockerfile --tag apilogicserver/api_logic_server:9.05.14 -o type=image --platform=linux/arm64,linux/amd64 .
