...
# docker tag apilogicserver/api_logic_server apilogicserver/api_logic_server:9.00.00
# docker push apilogicserver/api_logic_server:9.00.00
...
# python:3.9-slim-bullseye (Debian Linux 11) is 638MB, with SqlServer (here) is 815M
