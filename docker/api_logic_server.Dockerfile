...
# docker buildx build --push -f docker/api_logic_server.Dockerfile --tag apilogicserver/api_logic_server_x:9.01.33 -o type=image --platform=linux/arm64,linux/amd64 .
