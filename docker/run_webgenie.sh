...
docker run -it --rm --name webgenie -p 8282:80  --env-file ./../../webg-config/web_genai.txt  -v ./../../webg-projects:/opt/projects apilogicserver/web_genai

# docker run -it -p 8282:80 --env-file /opt/webgenai_env apilogicserver/web_genai
