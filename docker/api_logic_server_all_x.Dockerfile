...
# docker buildx build --push -f docker/api_logic_server_all_x.Dockerfile --tag apilogicserver/api_logic_server_all_x -o type=image --platform=linux/arm64,linux/amd64 .
# docker tag apilogicserver/api_logic_server_all_x apilogicserver/api_logic_server_all_x:9.01.12
# docker buildx build --push --tag apilogicserver/api_logic_server_all_x:9.01.12 --platform=linux/arm64,linux/amd64 .

# cd ~/dev/ApiLogicServer/ApiLogicServer-dev/build_and_test/ApiLogicServer/dockers
# docker run -it --name api_logic_server --rm --net dev-network -p 5656:5656 -p 5002:5002 -v ${PWD}:/localhost apilogicserver/api_logic_server_all_x
...
# docker buildx create --name mybuilder   # first time only setup
# docker buildx use mybuilder
# ok!  delete: docker dockerx rm mybuilder

# docker buildx build -f docker/api_logic_server_all_x.Dockerfile --tag apilogicserver/api_logic_server_all_x -o type=image --platform=linux/arm64,linux/amd64 .
