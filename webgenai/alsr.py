...
###############################################################################
#
#    This file initializes and starts the API Logic Server (v 10.04.61, June 16, 2024 17:51:49):
...
app_logger.info(f'Created June 16, 2024 17:51:49 at {str(current_path)}\n')
...
if __name__ == "__main__":
    msg = f'API Logic Project loaded (not WSGI), version 10.04.61\n'
    ...
    msg = f'API Logic Project Loaded (WSGI), version 10.04.61\n'
    msg += f'.. startup message: {start_up_message}\n'
