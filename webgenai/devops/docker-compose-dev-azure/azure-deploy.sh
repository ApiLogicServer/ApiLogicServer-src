...
resourcename="webgenie"  # lower case, only
resourcegroup="webgenie_rg"
...
# git clone https://github.com/apilogicserver/webgenie.git
# cd webgenie
...
az group create --name webgenie_rg --location "westus"
az appservice plan create --name myAppServicePlan --resource-group webgenie_rg --sku S1 --is-linux
az container create --resource-group webgenie_rg --name webgenie --image apilogicserver/webgenie:latest --dns-name-label webgenie --ports 5656 --environment-variables 'VERBOSE'='True'  'APILOGICPROJECT_CLIENT_URI'='//webgenie.westus.azurecontainer.io:5656'
